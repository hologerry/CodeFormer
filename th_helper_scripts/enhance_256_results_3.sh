...
python inference_codeformer.py -w 0.5 -s 1 --face_upsample --bg_upsampler realesrgan --input_path /D_data/Front/free_face_voice_driving_generation_results/voice_v2v_none_none_mouth_jaw_reconheadkp-mlevel-imgsefeatse3wdcncatfuse-light_voice_driving_demo_500/male4_5__05_000074

python inference_codeformer.py -w 0.5 -s 1 --face_upsample --bg_upsampler realesrgan --input_path /D_data/Front/free_face_voice_driving_generation_results/voice_v2v_none_none_mouth_jaw_reconheadkp-mlevel-imgsefeatse3wdcncatfuse-light_voice_driving_demo_500/male4_5__05_000109
